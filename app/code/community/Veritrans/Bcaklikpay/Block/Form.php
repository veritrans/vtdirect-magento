 ...
 */
class Veritrans_Bcaklikpay_Block_Form extends Mage_Payment_Block_Form
{
    
    protected function _construct()
    {
        parent::_construct();
		$this->setFormMessage(Mage::helper('bcaklikpay/data')->_getFormMessage());
        $this->setTemplate('bcaklikpay/form.phtml');
    }
}
?>