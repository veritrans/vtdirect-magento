 ...
 */
class Veritrans_Bcava_Block_Form extends Mage_Payment_Block_Form
{
    
    protected function _construct()
    {
        parent::_construct();
		$this->setFormMessage(Mage::helper('bcava/data')->_getFormMessage());
        $this->setTemplate('bcava/form.phtml');
    }
}
?>